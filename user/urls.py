...
urlpatterns = [
    ...
    path('mypantry/ingredient/shopping/pantry/<int:recipeName>/<int:ingredientName>/<int:quantity>/<str:unit>', UserIngredientShoppingCreate.as_view(), name='user-pantry-shopping-ingredient')
]